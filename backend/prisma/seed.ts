...
async function main() {
  ...
  const resources = await Promise.all([
    // POWDER
    prisma.resource.upsert({ where: { slug: 'po-ori' }, update: {}, create: { name: 'Poeira de Ori', slug: 'po-ori', category: 'POWDER', mobile: true, obtainHint: 'Drop de mobs, loja' } }),
    prisma.resource.upsert({ where: { slug: 'pl' }, update: {}, create: { name: 'Poeira de Lactolerium', slug: 'pl', category: 'POWDER', mobile: true, obtainHint: 'Drop de mobs, eventos, quests' } }),
    prisma.resource.upsert({ where: { slug: 'lac-100' }, update: {}, create: { name: 'Lactolerium 100%', slug: 'lac-100', category: 'POWDER', mobile: true, obtainHint: 'Loja NP, eventos' } }),

    // CRYSTAL
    prisma.resource.upsert({ where: { slug: 'crystal-bahamut' }, update: {}, create: { name: 'Crystal Bahamut', slug: 'crystal-bahamut', category: 'CRYSTAL', mobile: false, obtainHint: 'Dragon Field, Quest Bahamut Fury' } }),
    prisma.resource.upsert({ where: { slug: 'crystal-amunra' }, update: {}, create: { name: 'Crystal Amunra', slug: 'crystal-amunra', category: 'CRYSTAL', mobile: false, obtainHint: 'Dragon Field, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'anubis-crystal' }, update: {}, create: { name: 'Anubis Crystal', slug: 'anubis-crystal', category: 'CRYSTAL', mobile: true, obtainHint: 'Tesouro Anubis, Kefra, IceQueenVerid' } }),
    prisma.resource.upsert({ where: { slug: 'loki-crystal' }, update: {}, create: { name: 'Loki Crystal (Amunra)', slug: 'loki-crystal', category: 'CRYSTAL', mobile: false, obtainHint: 'Lapidação de Pedra Amunra' } }),
    prisma.resource.upsert({ where: { slug: 'primordial-crystal' }, update: {}, create: { name: 'Primordial Crystal', slug: 'primordial-crystal', category: 'CRYSTAL', mobile: false, obtainHint: 'NPC Zaid Naib, Noatun' } }),

    // STONE
    prisma.resource.upsert({ where: { slug: 'joia-escuridao' }, update: {}, create: { name: 'Joia da Escuridão', slug: 'joia-escuridao', category: 'STONE', mobile: true, obtainHint: 'Drop, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'pedra-lunar' }, update: {}, create: { name: 'Pedra Lunar', slug: 'pedra-lunar', category: 'STONE', mobile: true, obtainHint: 'Drop, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'pedra-imortalidade' }, update: {}, create: { name: 'Pedra da Imortalidade', slug: 'pedra-imortalidade', category: 'STONE', mobile: true, obtainHint: 'Eventos, loja NP' } }),
    prisma.resource.upsert({ where: { slug: 'pedra-furia' }, update: {}, create: { name: 'Pedra da Fúria', slug: 'pedra-furia', category: 'STONE', mobile: true, obtainHint: 'Eventos, quests' } }),
    prisma.resource.upsert({ where: { slug: 'kit-secretas' }, update: {}, create: { name: 'Kit Secretas (Sol/Água/Terra/Vento)', slug: 'kit-secretas', category: 'STONE', mobile: true, obtainHint: 'Drop, eventos' } }),

    // EMBLEM
    prisma.resource.upsert({ where: { slug: 'emblema-valk' }, update: {}, create: { name: 'Emblema da Valkyria', slug: 'emblema-valk', category: 'EMBLEM', mobile: true, obtainHint: 'Arena Real, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'emblema-valk-9' }, update: {}, create: { name: 'Emblema da Valkyria +9', slug: 'emblema-valk-9', category: 'EMBLEM', mobile: true, obtainHint: 'Refinação de Emblema da Valkyria' } }),

    // MEDAL
    prisma.resource.upsert({ where: { slug: 'medalha-vermelha' }, update: {}, create: { name: 'Medalha Vermelha', slug: 'medalha-vermelha', category: 'MEDAL', mobile: false, obtainHint: 'Arena Real, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'medalha-roxa' }, update: {}, create: { name: 'Medalha Roxa', slug: 'medalha-roxa', category: 'MEDAL', mobile: false, obtainHint: 'Arena, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'medalha-dourada' }, update: {}, create: { name: 'Medalha Dourada', slug: 'medalha-dourada', category: 'MEDAL', mobile: false, obtainHint: 'Arena, eventos' } }),

    // DRAGON
    prisma.resource.upsert({ where: { slug: 'rd-scale' }, update: {}, create: { name: 'RD Scale', slug: 'rd-scale', category: 'DRAGON', mobile: false, obtainHint: 'Dragon Field' } }),
    prisma.resource.upsert({ where: { slug: 'dragon-soul' }, update: {}, create: { name: 'Dragon Soul', slug: 'dragon-soul', category: 'DRAGON', mobile: false, obtainHint: 'Dragon Field, Quest Bahamut Fury' } }),
    prisma.resource.upsert({ where: { slug: 'dragon-essence' }, update: {}, create: { name: 'Dragon Essence', slug: 'dragon-essence', category: 'DRAGON', mobile: false, obtainHint: 'NPC Anubis — Fire Scale + Dragon Heart + Flame Core' } }),

    // BAHAMUT
    prisma.resource.upsert({ where: { slug: 'bahamut-horn' }, update: {}, create: { name: 'Bahamut Horn', slug: 'bahamut-horn', category: 'BAHAMUT', mobile: false, obtainHint: 'Quest Bahamut Fury, Dragon Field' } }),
    prisma.resource.upsert({ where: { slug: 'bahamut-rune' }, update: {}, create: { name: 'Bahamut Rune', slug: 'bahamut-rune', category: 'BAHAMUT', mobile: false, obtainHint: 'Quest Bahamut Fury, Dragon Field' } }),
    prisma.resource.upsert({ where: { slug: 'bahamut-soul' }, update: {}, create: { name: 'Bahamut Soul', slug: 'bahamut-soul', category: 'BAHAMUT', mobile: false, obtainHint: 'NPC Alyndra — composição' } }),
    prisma.resource.upsert({ where: { slug: 'bahamut-blood' }, update: {}, create: { name: 'Bahamut Blood', slug: 'bahamut-blood', category: 'BAHAMUT', mobile: false, obtainHint: 'Quest Bahamut Fury' } }),
    prisma.resource.upsert({ where: { slug: 'bahamut-simbol' }, update: {}, create: { name: 'Bahamut Simbol', slug: 'bahamut-simbol', category: 'BAHAMUT', mobile: false, obtainHint: 'Dragon Field, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'bahamut-essence' }, update: {}, create: { name: 'Bahamut Essence', slug: 'bahamut-essence', category: 'BAHAMUT', mobile: false, obtainHint: 'NPC Torvald — composição' } }),
    prisma.resource.upsert({ where: { slug: 'ancient-relic' }, update: {}, create: { name: 'Ancient Relic', slug: 'ancient-relic', category: 'BAHAMUT', mobile: false, obtainHint: 'NPC Zaid Naib — Eye of Wisdom ou 2x Primordial Crystal' } }),

    // TEAR
    prisma.resource.upsert({ where: { slug: 'lagrima-azul' }, update: {}, create: { name: 'Lágrima Azul (Sadness)', slug: 'lagrima-azul', category: 'TEAR', mobile: false, obtainHint: 'Falha na refinação de Brinco Bahamut' } }),
    prisma.resource.upsert({ where: { slug: 'lagrima-amarela' }, update: {}, create: { name: 'Lágrima Amarela (Happiness)', slug: 'lagrima-amarela', category: 'TEAR', mobile: false, obtainHint: 'Falha na refinação de Colar/Cinto Bahamut' } }),
    prisma.resource.upsert({ where: { slug: 'lagrima-vermelha' }, update: {}, create: { name: 'Lágrima Vermelha (Rage)', slug: 'lagrima-vermelha', category: 'TEAR', mobile: false, obtainHint: 'Falha no upgrade de Tier de acessório Bahamut' } }),
    prisma.resource.upsert({ where: { slug: 'lagrima-lucky' }, update: {}, create: { name: 'Lágrima Lucky', slug: 'lagrima-lucky', category: 'TEAR', mobile: false, obtainHint: 'NPC Torvald — conversão de outras lágrimas' } }),

    // CYTHERA
    prisma.resource.upsert({ where: { slug: 'cursed-hat-black' }, update: {}, create: { name: 'Cursed Hat (Black)', slug: 'cursed-hat-black', category: 'CYTHERA', mobile: true, obtainHint: 'Drop de mobs de alto nível' } }),
    prisma.resource.upsert({ where: { slug: 'barra-prata' }, update: {}, create: { name: 'Barra de Prata (1Bi)', slug: 'barra-prata', category: 'CYTHERA', mobile: true, obtainHint: 'Loja, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'folha-mandragora' }, update: {}, create: { name: 'Folha de Mandrágora', slug: 'folha-mandragora', category: 'CYTHERA', mobile: true, obtainHint: 'Loja NP, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'amago-dl' }, update: {}, create: { name: 'Âmago de Dragão Lendário', slug: 'amago-dl', category: 'CYTHERA', mobile: true, obtainHint: 'Drop de Dragão Lendário' } }),
    prisma.resource.upsert({ where: { slug: 'royal-arena-coupon' }, update: {}, create: { name: 'Royal Arena Coupon', slug: 'royal-arena-coupon', category: 'COIN', mobile: false, obtainHint: 'Arena Real' } }),

    // MANTLE
    prisma.resource.upsert({ where: { slug: 'selo-magico' }, update: {}, create: { name: 'Selo Mágico', slug: 'selo-magico', category: 'MANTLE', mobile: true, obtainHint: 'Drop, quests' } }),
    prisma.resource.upsert({ where: { slug: 'pergaminho-selado' }, update: {}, create: { name: 'Pergaminho Selado', slug: 'pergaminho-selado', category: 'MANTLE', mobile: true, obtainHint: 'Drop, quests' } }),
    prisma.resource.upsert({ where: { slug: 'ruby' }, update: {}, create: { name: 'Ruby', slug: 'ruby', category: 'MANTLE', mobile: false, obtainHint: 'Loja NP, eventos' } }),

    // MOUNT
    prisma.resource.upsert({ where: { slug: 'amago-tf-0' }, update: {}, create: { name: 'Âmago Tigre de Fogo +0', slug: 'amago-tf-0', category: 'MOUNT', mobile: true, obtainHint: 'Drop de mobs' } }),
    prisma.resource.upsert({ where: { slug: 'amago-dv-0' }, update: {}, create: { name: 'Âmago Dragão Vermelho +0', slug: 'amago-dv-0', category: 'MOUNT', mobile: true, obtainHint: 'Drop de mobs' } }),
    prisma.resource.upsert({ where: { slug: 'amago-dl-0' }, update: {}, create: { name: 'Âmago Dragão Lendário +0', slug: 'amago-dl-0', category: 'MOUNT', mobile: true, obtainHint: 'Drop de mobs' } }),
    prisma.resource.upsert({ where: { slug: 'amago-tf-10' }, update: {}, create: { name: 'Âmago Tigre de Fogo +10', slug: 'amago-tf-10', category: 'MOUNT', mobile: false, obtainHint: 'NPC MountKeeper — composição' } }),
    prisma.resource.upsert({ where: { slug: 'amago-dv-10' }, update: {}, create: { name: 'Âmago Dragão Vermelho +10', slug: 'amago-dv-10', category: 'MOUNT', mobile: false, obtainHint: 'NPC MountKeeper — composição' } }),
    prisma.resource.upsert({ where: { slug: 'amago-dl-10' }, update: {}, create: { name: 'Âmago Dragão Lendário +10', slug: 'amago-dl-10', category: 'MOUNT', mobile: false, obtainHint: 'NPC MountKeeper — composição' } }),
    prisma.resource.upsert({ where: { slug: 'amago-jackal-0' }, update: {}, create: { name: 'Âmago de Jackal +0', slug: 'amago-jackal-0', category: 'MOUNT', mobile: true, obtainHint: 'NPC MountKeeper — Ovo Vermelho + Ovo Azul' } }),
    prisma.resource.upsert({ where: { slug: 'amago-jackal-10' }, update: {}, create: { name: 'Âmago de Jackal +10', slug: 'amago-jackal-10', category: 'MOUNT', mobile: false, obtainHint: 'NPC MountKeeper — composição' } }),
    prisma.resource.upsert({ where: { slug: 'ovo-azul' }, update: {}, create: { name: 'Ovo Azul', slug: 'ovo-azul', category: 'MOUNT', mobile: false, obtainHint: 'SandLich, IceLich, Kefra, NPC MountKeeper' } }),
    prisma.resource.upsert({ where: { slug: 'ovo-amarelo' }, update: {}, create: { name: 'Ovo Amarelo', slug: 'ovo-amarelo', category: 'MOUNT', mobile: false, obtainHint: 'SandLich, IceLich, Kefra, NPC MountKeeper' } }),
    prisma.resource.upsert({ where: { slug: 'ovo-vermelho' }, update: {}, create: { name: 'Ovo Vermelho', slug: 'ovo-vermelho', category: 'MOUNT', mobile: false, obtainHint: 'NPC MountKeeper — composição' } }),
    prisma.resource.upsert({ where: { slug: 'soul-fragment' }, update: {}, create: { name: 'Soul Fragment', slug: 'soul-fragment', category: 'MOUNT', mobile: true, obtainHint: 'Drop de bosses' } }),
    prisma.resource.upsert({ where: { slug: 'jackal-armor' }, update: {}, create: { name: 'Jackal Armor', slug: 'jackal-armor', category: 'MOUNT', mobile: false, obtainHint: 'NPC MountKeeper — composição de escudos' } }),

    // COIN / OTHER
    prisma.resource.upsert({ where: { slug: 'gold' }, update: {}, create: { name: 'Gold (kk)', slug: 'gold', category: 'COIN', mobile: true, obtainHint: 'Farm, comércio' } }),
    prisma.resource.upsert({ where: { slug: 'guild-coin' }, update: {}, create: { name: 'Guild Coin', slug: 'guild-coin', category: 'COIN', mobile: false, obtainHint: 'Eventos de guild' } }),
    prisma.resource.upsert({ where: { slug: 'wyden-coin' }, update: {}, create: { name: 'Wyden Coin', slug: 'wyden-coin', category: 'COIN', mobile: true, obtainHint: 'Loja NP, eventos' } }),
    prisma.resource.upsert({ where: { slug: 'hunting-loot' }, update: {}, create: { name: 'Hunting Loot', slug: 'hunting-loot', category: 'OTHER', mobile: false, obtainHint: 'Quest Caçador de Espólios' } }),
    prisma.resource.upsert({ where: { slug: 'mount-growth-stabilizer' }, update: {}, create: { name: 'Mount Growth Stabilizer', slug: 'mount-growth-stabilizer', category: 'MOUNT', mobile: true, obtainHint: 'NPC Ehre — Selo Mágico + 20 PL' } }),
    prisma.resource.upsert({ where: { slug: 'relic-protection' }, update: {}, create: { name: 'Relic of Protection (Selada)', slug: 'relic-protection', category: 'OTHER', mobile: false, obtainHint: 'NPC Anubis, Noatun' } }),
    prisma.resource.upsert({ where: { slug: 'relic-power' }, update: {}, create: { name: 'Relic of Power (Selada)', slug: 'relic-power', category: 'OTHER', mobile: false, obtainHint: 'NPC Anubis, Noatun' } }),
  ...
  const r = Object.fromEntries(
    resources.map(res => [res.slug, res])
  )
  ...
  const processes = [
    ...
    // === ARMADURA/ARMA RD ===
    {
      ...
      category: 'ARMOR',
      fromLevel: 9, toLevel: 15,
      notes: 'Dragon Soul NÃO é consumido em falha — apenas recebe +1 refinação (max +9). Quanto maior o Dragon Soul, maior a chance.',
      resources: [
    ...
    },
    {
      ...
      category: 'ARMOR',
      notes: 'Bahamut Soul NÃO é consumido em falha — recebe +1 refinação. Requer Ignite Buff.',
      resources: [
        { slug: 'bahamut-horn', quantity: 1, isConsumedOnFail: true },
    ...
    },
    {
      ...
      category: 'CYTHERA',
      notes: '+0→+6: 100% | +6→+9: 80% | +9→+10: 50% | +10→+11: 30% | +11→+12: 10% | +12→+14: 8% | +14→+15: 5%',
      resources: [
    ...
    },
    {
      ...
      resources: [
        { slug: 'lac-100', quantity: 1, isConsumedOnFail: true },
      ]
    },
    {
    ...
    },
    {
      ...
      category: 'ACCESSORY',
      successRate: 0.25,
      notes: 'NPC Lapidário, Arzan. Em falha mantém refinação. +13→+14: 25% | +14→+15: 10%.',
      resources: [
    ...
    // === ACESSÓRIOS BAHAMUT ===
    {
      ...
      category: 'ACCESSORY',
      notes: '+0→+9: 40% | +9→+11: 5%. Em falha não volta refinação. 10% chance Lágrima Azul.',
      resources: [
        { slug: 'crystal-bahamut', quantity: 1, isConsumedOnFail: true },
        { slug: 'pl', quantity: 1, isConsumedOnFail: true },
        { slug: 'gold', quantity: 10, isConsumedOnFail: true },
    ...
    },
    {
      ...
      category: 'ACCESSORY',
      notes: '+11→+12: 20% | +12→+13: 15% | +13→+14: 10% | +14→+15: 5%. Em falha volta para +11.',
      resources: [
        { slug: 'crystal-bahamut', quantity: 1, isConsumedOnFail: true },
        { slug: 'pl', quantity: 1, isConsumedOnFail: true },
        { slug: 'gold', quantity: 10, isConsumedOnFail: true },
    ...
    },
    {
      ...
      category: 'ACCESSORY',
      notes: '+0→+5: 75% | +5→+7: 50% | +7→+10: 25% | +10→+11: 10%. Em falha mantém.',
      resources: [
        { slug: 'lac-100', quantity: 1, isConsumedOnFail: true },
      ]
    },
    ...
    },
    {
      ...
      category: 'ACCESSORY',
      notes: 'T1: 75% | T2: 20% | T3: 10% | T4: 5% | T5: 3% | T6: 1% | T7: 1%. Em falha ganha Lágrima Vermelha.',
      resources: [
    ...
    },
    {
      ...
      category: 'ACCESSORY',
      successRate: 0.10,
      notes: 'NPC Zaid Naib, Noatun. Requer Bahamut +15 T8. Em falha preserva o acessório.',
      resources: [
    ...
    },
    {
      ...
      category: 'MANTLE',
      successRate: 0.25,
      notes: 'NPC Balder, Azran. +10→+11: falha mantém. +12+: falha perde 1 nível.',
      resources: [
    ...
    },
    {
      ...
      category: 'MANTLE',
      successRate: 0.25,
      notes: 'NPC Balder, Azran. Requer Capa Celestial +15 com 4% Dano PvP e 4% Defesa PvP. Bahamut Soul não é consumido em falha — recebe 1 Bless. Com 6 Bless: 100% de sucesso.',
      resources: [
    ...
    // === MONTARIA ===
    {
      ...
      resources: [
        { slug: 'amago-dl-0', quantity: 1, isConsumedOnFail: true },
      ]
    },
    {
      ...
      resources: [
        { slug: 'amago-dl-10', quantity: 1, isConsumedOnFail: true },
      ]
    },
    {
      ...
      category: 'MOUNT',
      successRate: 0.30,
      notes: 'Requer montaria nível 200. +1, +2 ou +3 qualidade em sucesso. 1 tentativa/dia.',
      resources: [
    ...
    },
    {
      ...
      category: 'MOUNT',
      successRate: 0.20,
      notes: 'TF: 10% | DV: 15% | DL: 20%. Em falha montaria perde 10 qualidade.',
      resources: [
